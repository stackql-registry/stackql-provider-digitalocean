...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="droplet_snapshots" /></td></tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Describes the kind of image. It may be one of `snapshot` or `backup`. This specifies whether an image is a user-generated Droplet snapshot or automatically created Droplet backup. (snapshot, backup) (example: snapshot)</td>
</tr>
</tbody>
</table>
</TabItem>
