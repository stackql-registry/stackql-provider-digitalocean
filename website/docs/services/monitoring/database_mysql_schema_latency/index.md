--- 
title: database_mysql_schema_latency
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>database_mysql_schema_latency</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="database_mysql_schema_latency" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="digitalocean.monitoring.database_mysql_schema_latency" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="monitoring_get_database_mysql_schema_latency"
    values={[
        { label: 'monitoring_get_database_mysql_schema_latency', value: 'monitoring_get_database_mysql_schema_latency' }
    ]}
>
<TabItem value="monitoring_get_database_mysql_schema_latency">
...
<tbody>
<tr>
    <td><a href="#monitoring_get_database_mysql_schema_latency"><CopyableCode code="monitoring_get_database_mysql_schema_latency" /></a></td>
    ...
    <td></td>
    <td>Retrieve table I/O latency (seconds) for a schema. Requires **schema** and **metric** (insert, fetch, update, delete).</td>
</tr>
</tbody>
</table>
