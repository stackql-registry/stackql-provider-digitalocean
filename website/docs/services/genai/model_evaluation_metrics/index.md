--- 
title: model_evaluation_metrics
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>model_evaluation_metrics</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="model_evaluation_metrics" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="digitalocean.genai.model_evaluation_metrics" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="genai_list_model_evaluation_metrics"
    values={[
        { label: 'genai_list_model_evaluation_metrics', value: 'genai_list_model_evaluation_metrics' }
    ]}
>
<TabItem value="genai_list_model_evaluation_metrics">
...
<tbody>
<tr>
    <td><a href="#genai_list_model_evaluation_metrics"><CopyableCode code="genai_list_model_evaluation_metrics" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td></td>
    <td></td>
    <td>To list all available metrics for model evaluation, send a GET request to `/v2/genai/model_evaluation_metrics`.</td>
</tr>
</tbody>
</table>
...
range_min,
source
FROM digitalocean.genai.model_evaluation_metrics
;
```
</TabItem>
</Tabs>
