...
// This provider's website lives at website/ within the
// stackql/stackql-provider-digitalocean repo, so the "Edit this page" links
// point at that subdirectory (the shared config default omits the website/
// path and assumes the stackql-registry org).
config.projectName = 'stackql-provider-digitalocean';
config.presets[0][1].docs.editUrl =
  'https://github.com/stackql/stackql-provider-digitalocean/edit/main/website/';
